...
Note: this backend implemenation requires as connection with a PostGis database for the LPIS vector data set (demo uses a database instance populated with open government data of Austria) and a Sentinel Hub subscription for NDVI timestacks!
